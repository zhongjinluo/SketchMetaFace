...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_train.add_argument('--freq_save_ply', type=int, default=10, help='freqency of the save ply')
        ...
        g_sample.add_argument('--num_sample_inout', type=int, default=32000, help='# of sampling points')
        ...
        parser.add_argument('--num_gen_mesh_test', type=int, default=2,
