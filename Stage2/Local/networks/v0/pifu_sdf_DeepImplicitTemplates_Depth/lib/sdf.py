...
def create_grid_LM(locX, locY, resZ, b_min=np.array([0, 0, 0]), b_max=np.array([1, 1, 1]), transform=None):
    '''
    ...
    '''
    coords = np.mgrid[locX-32:locX+32, locY-32:locY+32, :resZ]
    coords = coords.reshape(3, -1)
    coords_matrix = np.eye(4)
    length = b_max - b_min
    coords_matrix[0, 0] = 1.0
    coords_matrix[1, 1] = 1.0
    ...
    coords = coords.reshape(3, 64, 64, resZ)
