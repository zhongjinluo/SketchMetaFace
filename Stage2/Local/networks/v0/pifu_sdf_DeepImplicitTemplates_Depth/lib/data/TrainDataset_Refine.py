...
class TrainDataset_Refine(Dataset):
    ...
    def __init__(self, opt, phase='train'):
        ...
        self.SAMPLE = os.path.join(self.root, 'M1M2_SDF')
        self.CALIB = os.path.join(self.root, 'CALIB')
        self.NORM = os.path.join(self.root, 'N')
        self.DEPTH = os.path.join(self.root, 'D')
    ...
    def get_subjects(self):
        ...
        if self.is_train:
            print("train_set: ", len(all_subjects[0:-50]))
            return all_subjects[0:-50]
        else:
            print("test_set: ", len(all_subjects[-50:]))
            return all_subjects[-50:]
